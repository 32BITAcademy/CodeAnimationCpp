...
#define ONE_INT(x) INT x(#x);
#define ONE_FLOAT(x) FLOAT x(#x);
#define ONE_DOUBLE(x) DOUBLE x(#x);
#define ONE_BOOL(x) BOOL x(#x);
#define ONE_CHAR(x) CHAR x(#x);

#define Int(...) FOR_EACH(ONE_INT, __VA_ARGS__)
#define Float(...) FOR_EACH(ONE_FLOAT, __VA_ARGS__)
#define Double(...) FOR_EACH(ONE_DOUBLE, __VA_ARGS__)
#define Bool(...) FOR_EACH(ONE_BOOL, __VA_ARGS__)
#define Char(...) FOR_EACH(ONE_CHAR, __VA_ARGS__)